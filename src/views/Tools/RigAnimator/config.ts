...
/** How long a T-pose has to be held before calibration captures it. */
export const DEFAULT_CALIBRATION_COUNTDOWN_SECONDS = 3
export const CALIBRATION_COUNTDOWN_RANGE = { min: 1, max: 10, step: 1 }
/** How far an arm may tilt off level, or bend at the elbow, and still read as a T-pose. */
export const DEFAULT_CALIBRATION_TOLERANCE_DEGREES = 20
export const CALIBRATION_TOLERANCE_RANGE = { min: 5, max: 45, step: 1 }
/** Horizontal field of view assumed for the webcam; most laptop and USB webcams sit near 60. */
export const DEFAULT_CALIBRATION_FIELD_OF_VIEW_DEGREES = 60
...
export const CALIBRATED_HAND_BONE_NAMES = {

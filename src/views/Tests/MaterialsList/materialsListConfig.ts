...
export const WAVE_Y_OFFSET = 0.5
...
export const DESCRIPTION_SPRITE_SCALE_X = 5.1
export const DESCRIPTION_SPRITE_SCALE_Y = 0.4
export const PROPERTIES_SPRITE_SCALE_X = 4.6
export const PROPERTIES_SPRITE_SCALE_Y = 0.36
...
export const PROPERTIES_Y_OFFSET = DESCRIPTION_Y_OFFSET + TEXT_Y_STEP * 3
...
export const SPECIAL_PROPERTIES_Y_OFFSET = SPECIAL_DESCRIPTION_Y_OFFSET + TEXT_Y_STEP * 3
...
export const SHOWCASE_LEGEND_SWATCH_Y = -5.5
export const SHOWCASE_LEGEND_LABEL_Y = -6.6

    ...
    defineSetup: ({ scene, world, clock, animate }) => {
      ...
      timeline.addAction({
        ...
        action: () => {
          ...
          cube.position.y = 1 + BOUNCE_HEIGHT * Math.abs(Math.sin(elapsed * BOUNCE_SPEED))
    ...
    [
      {
        id: 'cloud',
        name: 'Cloud',
        textures: [{ id: 'cloud-tex-1', name: 'cloud1', filename: 'cloud1', url: cloudImageUrl }]
      },
      {
        id: 'tree',
        name: 'Tree',
        textures: [{ id: 'tree-tex-1', name: 'Tree1-1', filename: 'Tree1-1', url: treeImageUrl }]
      }
    ],

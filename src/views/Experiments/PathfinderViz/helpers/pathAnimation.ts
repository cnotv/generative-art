  ...
  path.slice(1).forEach((targetCell, index) => {
    ...
    timelineManager.addAction({
      ...
      action: (frame?: number) => {
        ...
        const progress = Math.min(elapsed / framesPerCell, 1);

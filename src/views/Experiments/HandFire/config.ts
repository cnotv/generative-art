...
export const FLAME_PARTICLES_PER_HAND = 30
export const MAX_FIREBALLS = 8
export const FIREBALL_PARTICLES_PER_BALL = 8
/** How long a thrown fireball flies before despawning, in milliseconds. */
export const FIREBALL_LIFETIME_MS = 1800
export const AMBIENT_EMBER_COUNT = 70
...
export const configControls = {
  ...
  flameIntensity: { min: 0.3, max: 2, step: 0.1, label: 'Flame Intensity' }
}

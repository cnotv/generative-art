...
const addPosterGroup = (
  ...
  ;[
    {
      w: frameTotal,
      h: POSTER_FRAME_THICKNESS,
      x: 0,
      y: POSTER_HEIGHT / 2 + POSTER_FRAME_THICKNESS / 2
    },
    {
      w: frameTotal,
      h: POSTER_FRAME_THICKNESS,
    ...
    {
      w: POSTER_FRAME_THICKNESS,
      h: POSTER_HEIGHT,
      x: -(POSTER_WIDTH / 2 + POSTER_FRAME_THICKNESS / 2),
      y: 0
    },
    {
      w: POSTER_FRAME_THICKNESS,
...
export const createScorePoster = (scene: THREE.Scene) => {
  ...
  addPosterGroup(
    postersGroup,
    texture,
    new THREE.Vector3(0, POSTER_Y, -half + POSTER_WALL_OFFSET),
    0
  )
  addPosterGroup(
    postersGroup,
    texture,
    new THREE.Vector3(-half + POSTER_WALL_OFFSET, POSTER_Y, 0),
    Math.PI / 2
  )
  addPosterGroup(
    postersGroup,

...
export const DESK_PHYSICS_SIZE: CoordinateTuple = [
  DESK_PHYSICS_WIDTH,
  DESK_PHYSICS_HEIGHT,
  DESK_PHYSICS_WIDTH
]
...
export const PLAYER_START: CoordinateTuple = [
  -MAZE_ENTRANCE_OFFSET,
  PLAYER_Y,
  -MAZE_ENTRANCE_OFFSET
]
export const MAZE_EXIT_POSITION: CoordinateTuple = [
  MAZE_ENTRANCE_OFFSET,
  PLAYER_Y,
  MAZE_ENTRANCE_OFFSET
]
...
export const ELEVATOR_PHYSICS_SIZE: CoordinateTuple = [
  ELEVATOR_PHYSICS_WIDTH,
  ELEVATOR_PHYSICS_HEIGHT,
 ...
 */
export const generateWallPositions = (islandSize: number, cellSize: number): CoordinateTuple[] => {

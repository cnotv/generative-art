...
describe('animation', () => {
  ...
  describe('playAction', () => {
    ...
    it('should register finished event listener for LoopOnce', () => {
      ...
      expect(model.userData.mixer.addEventListener).toHaveBeenCalledWith(
        'finished',
        expect.any(Function)
      )
    })
  ...
  describe('playActionTimeline', () => {
    ...
    ])('should set correct blocking flags for $action', ({ action, options, expected }) => {

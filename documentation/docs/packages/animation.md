...
```typescript
import { poseCapture, poseApply } from '@webgamekit/animation'
...
```typescript
import { rigGenerateHumanoidSkeleton, rigAutoSkinMesh } from '@webgamekit/animation'
